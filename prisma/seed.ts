...
async function main() {
  ...
  const courseDefs = [
    ...
    },
    {
      ...
      city: "Dublin",
      state: "OH",
      website: "https://www.golfclubofdublin.com/",
      notes: "Hurdzan/Fry links design (2002) with fescue dunes, 64 stacked sod bunkers, and hand-stacked rock walls — built to feel like the British Isles. Membership club.",
      approved: true,
      active: true,
    },
    {
      name: "Bent Tree Golf Club",
      city: "Sunbury",
      state: "OH",
      website: "https://www.benttreegc.com/",
      notes: "Denis Griffiths design (1988), par 72 at 6,805 yards, open to the public.",
      approved: true,
      active: true,
    },
    {
      name: "Glenross Golf Club",
      city: "Delaware",
      state: "OH",
      website: "https://www.glenrossgc.com/",
      notes: "Jack Kidwell design (2006) with 50 bunkers, seven ponds, and a creek. Signature par-3 14th plays over water. Membership club.",
      approved: true,
      active: true,
    },
    {
      ...
      city: "New Albany",
      state: "OH",
      website: "https://www.newalbanylinks.com/",
      notes: "Barry Serafin design (2000) across rolling hills, creeks, and wetlands — water comes into play on several holes. Membership club.",
      approved: true,
      active: true,
    },
    {
      ...
      city: "Johnstown",
      state: "OH",
      website: "https://www.clovervalleygolfclub.com/",
      notes: "Public parkland/links mix (opened 2001–02) with water in play on at least five holes and an on-site driving range.",
      approved: true,
      active: true,
    },
  ];
