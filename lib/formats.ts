...
export const FORMAT_INFO: Record<MatchFormat, FormatInfo> = {
  ...
  OVERALL: {
    ...
    description:
      "The twosome's combined gross score across all 18 holes, compared straight up against the opposing twosome's. Independent of who won the front-9 and back-9 matches, lower total wins the point.",
