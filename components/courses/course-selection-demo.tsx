...
import { ChevronDown, PartyPopper, Shuffle } from "lucide-react";
 ...
 * Collapsed by default so it doesn't compete for space with the real
 * matches below it. */
export function CourseSelectionDemo({ courses }: { courses: Course[] }) {
  ...
  return (
    <div className="rounded-2xl border-2 border-dashed border-gold-500/60 bg-gold-50/40">
      <button
        type="button"
